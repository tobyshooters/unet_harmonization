...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        ...
        self.inc = DoubleConv(n_channels, 64)  # out: n
        self.down1 = Down(64, 128)             # out: n/2
        self.down2 = Down(128, 256)            # out: n/4
        self.down3 = Down(256, 512)            # out: n/8
        self.down4 = Down(512, 1024 // factor) # out: n/16
